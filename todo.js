...
$(function() {
    ...
    function make_list(){
        ...
        num++;
        $("#list_frame").append(
            "<div class='level"+Level.value+"' id='list"+num+"'><span class='list_todo'>"+Things.value+"</span>"+Limit_d.value+"/"+Limit_t.value+"<button id='complete' class='complete' onclick='complete_list("+num+","+Level.value+")'>完了</button></div>");
        cancel_input();
    }
